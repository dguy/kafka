...
public class Materialized<K, V, S extends StateStore> {
    private StoreSupplier<S> storeSupplier;
     ...
     * @return a new {@code Materialized} instance with the given storeName
     */
     ...
     * @param <K>      key type of the store
     * @param <V>      value type of the store
     * @return a new {@code Materialized} instance with the given supplier
     */
